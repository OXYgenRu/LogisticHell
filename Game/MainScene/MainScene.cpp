...
void MainScene::init_tree(EngineContext &ctx) {
    ...
    ctx.app->texture_atlas->register_texture("icon", "blocks/Icon.png");
    ctx.app->texture_atlas->register_texture("construction_block", "blocks/TestConstructionBlock.png");
    ctx.app->texture_atlas->register_texture("hull", "blocks/Hull.png");
